...
export class ApiService {
  ...
  download(path: string, params: URLSearchParams = new URLSearchParams()): Observable<any> {
    return this.http.get(`${environment.API_URL}${path}`, { search: params, responseType: ResponseContentType.ArrayBuffer })
      .catch(this.formatErrors)
